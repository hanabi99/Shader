Shader "Unlit/Edge_BackGround"
{
    Properties
    {
        ...
        //bg 到 原图的插值
        _BackGroundToMainTexLerp ("BackGround To MainTex", Range(0,1)) = 0
    }
    SubShader
    {
        Tags
        ...
        Pass
        {
            ...
            fixed _BackGroundToMainTexLerp;
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                return lerp(color, onlyEdgeColor, _BackGroundToMainTexLerp);
